              ...
              <>
                ...
                <div className="flex items-center space-x-1">
                  <div className="relative" ref={semifinalOptionsRef}>
                    <button
                      className="px-4 py-2 rounded-md text-sm font-medium  hover:from-indigo-700 hover:to-purple-800 transition duration-300"
                  ...
                  <div className="relative" ref={profileMenuRef}>
                    <button
                      className="p-2 rounded-full  hover:from-indigo-700 hover:to-purple-800 transition duration-300 focus:outline-none"
